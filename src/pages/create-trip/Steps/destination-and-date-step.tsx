...
export function DestinationAndDateStep({isGuestsInputOpen, closeGuestsInputs, openGuestsInputs, setDestination, eventStartAndDates, setEventStartAndDates}: DestinationAndDateStepProps){
    ...
    return(
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
                    ...
                    <div className='rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                <button onClickCapture={closeDatePicker} type='button'><X className='size-5 text-zinc-400' /></button>
                            </div>
                        </div>
            ...
            {isGuestsInputOpen ? (
                <Button onClick={closeGuestsInputs} variant="secundary">
                    Alterar local/data
